    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 650px;">
            ...
            <div class="container-fluid">
                ...
                <?php 
                    include 'koneksi.php';
                    $hit1 = "SELECT COUNT(id) as jumlah FROM surat WHERE tipe_surat = 'masuk'";
                    $datax = mysqli_fetch_row(mysqli_query($con, $hit1));
                    $masuk = $datax[0];

                    $hit2 = "SELECT COUNT(id) as jumlah FROM surat WHERE tipe_surat = 'keluar'";
                    $datay = mysqli_fetch_row(mysqli_query($con, $hit2));
                    $keluar = $datay[0];
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo "$masuk"; ?></div>
                                        <div>Surat Masuk</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo "$keluar"; ?></div>
