...
<?php 
    ...
    $perintah = "SELECT * FROM surat WHERE tipe_surat = 'keluar' ORDER BY id DESC";
                                ...
                                <?php 
                                 ...
                                 ?>
                                    <tr>
                                        ...
                                        <a onclick="return confirm('Apakah Data Akan Dihapus?')" href="keluar.php?delete=true&id=<?php echo "$data[id]"; ?>" class="btn btn-warning">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php 
                                    } ?>
