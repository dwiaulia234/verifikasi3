...
<?php 
    ...
    $admin = $_SESSION['id'];
    $gas = "SELECT * FROM user WHERE id = '$admin'";
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">       
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="" <?php echo "value='$data[username]'"; ?> disabled>
                            </div>
                            ...
                            <a href="username.php?id=<?php echo $_SESSION['id']; ?>" class="btn btn-primary">Edit Username</a>
                            <a href="password.php?id=<?php echo $_SESSION['id']; ?>" class="btn btn-success">Edit Password</a>
                        </form>
